...
class PhaseManager:
    def __init__(self, MainPhase : Literal["Strategy", "Action", "Status", "Agenda"] = None, SubPhase = None):
        self.MainPhase : Phases = None

        self.ActionType: ActionType = None # Strategic, tactical or Component
